...
id:"gx-at",
name:"GX AT",
price:{nik2025:403200000}
},

{
id:"gx-at-2tone",
name:"GX AT 2 Tone",
price:{nik2025:406100000}
}
...
const priceEl = qs("modal-price") || qs("modal-product-price");
...
priceEl.innerHTML = `
NIK 2025 : Rp ${formatRupiah(currentVariant.price.nik2025)}
<br>
NIK 2026 : Rp ${formatRupiah(currentVariant.price.nik2026)}
`;

}else{

priceEl.textContent = "Rp " + formatRupiah(currentVariant.price.nik2025);
