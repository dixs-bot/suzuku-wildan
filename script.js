/*******************************************************************
  ...
  - Data produk (termasuk XL7 Kuro)
  - Render kartu produk + badge FRONX NEW & KURO EDITION
  - Modal detail + simulasi kredit per produk
...
const products = [
  // ================== PASSENGER ==================
  {
    ...
    badge: "new", // untuk badge "NEW LAUNCH"
    variants: [
      {
        id: "gl-mt",
        name: "GL MT",
...

  {
    ...
    badge: "kuro", // untuk badge KURO EDITION
    variants: [
      {
        id: "zeta-mt",
        name: "Zeta MT",
...
/* ================================================================
   ...
   (pakai nama file SEO-friendly yang kamu kirim)
================================================================ */
